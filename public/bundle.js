var app = (function () {
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text("\r\n        正则大全");
    			attr_dev(path, "d", "M80.457143 687.542857h256v256H80.457143zM958.171429\r\n              277.942857l-36.571429-65.828571-160.914286\r\n              102.4V124.342857h-73.142857v190.171429L526.628571\r\n              212.114286l-43.885714 65.828571L658.285714 387.657143 482.742857\r\n              497.371429l43.885714 58.514285\r\n              160.914286-102.4v190.171429h73.142857V453.485714l160.914286 102.4\r\n              36.571429-58.514285-168.228572-109.714286z");
    			attr_dev(path, "p-id", "2464");
    			add_location(path, file$1, 20, 12, 639);
    			...
    			add_location(svg, file$1, 11, 10, 369);
    			attr_dev(div0, "class", "w-8 h-8 mr-2 flex items-center justify-center bg-white\r\n          text-indigo-600");
    			add_location(div0, file$1, 8, 8, 251);
    			attr_dev(div1, "class", "flex items-center flex-1");
    			add_location(div1, file$1, 7, 6, 203);
    			attr_dev(div2, "class", "flex items-center py-4 text-2xl font-bold ");
    			add_location(div2, file$1, 6, 4, 139);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(svg, file$2, 29, 8, 783);
    			attr_dev(button, "class", "text-gray-400 focus:outline-none");
    			add_location(button, file$2, 28, 6, 701);
    			attr_dev(div, "class", "absolute top-0 right-0 w-12 h-12 flex item-center justify-end pr-4");
    			add_location(div, file$2, 25, 4, 563);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "w-full p-4 h-12 pr-10 rounded-md border-2 focus:border-indigo-400\r\n    focus:outline-none focus:shadow");
    			add_location(input, file$2, 17, 2, 326);
    			attr_dev(div, "class", "relative");
    			add_location(div, file$2, 16, 0, 300);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span = element("span");
    			t1 = text(/*label*/ ctx[0]);
    			attr_dev(path, "d", "M513.720178 62.432934c-247.53163 0-448.195835 200.664206-448.195835\r\n      448.195835 0 247.532653 200.664206 448.195835 448.195835 448.195835\r\n      247.532653 0 448.195835-200.662159 448.195835-448.195835C961.916013\r\n      263.098163 761.251807 62.432934 513.720178 62.432934L513.720178\r\n      62.432934zM770.794138 394.371976 480.923214 684.245969c0 0-0.00307\r\n      0.00307-0.00921 0.00921-13.363356 13.367449-33.740452 15.45397-49.295729\r\n      6.265704-2.880607-1.702782-5.597485-3.793396-8.070816-6.265704-0.002047-0.00307-0.005117-0.005117-0.005117-0.005117L256.647241\r\n      517.354961c-15.84078-15.84078-15.84078-41.527812 0-57.372685\r\n      15.84078-15.84078 41.527812-15.84078 57.368592 0l138.215922 138.215922\r\n      261.193791-261.193791c15.842827-15.84078 41.529859-15.84078 57.370639\r\n      0C786.634918 352.84621 786.634918 378.531196 770.794138\r\n      394.371976L770.794138 394.371976z");
    			attr_dev(path, "p-id", "17302");
    			add_location(path, file$3, 24, 4, 581);
    			...
    			add_location(svg, file$3, 15, 2, 330);
    			attr_dev(span, "class", "capitalize");
    			add_location(span, file$3, 39, 2, 1538);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 75, 6, 1936);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "absolute right-0 flex-shrink-0 py-1 px-2 text-xs text-white\r\n          bg-green-400 rounded origin-right");
    			add_location(div, file$4, 91, 8, 2566);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			current = true;
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 62, 2, 1365);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", input_placeholder_value = "例如：" + /*rule*/ ctx[0].examples.join("，"));

    			attr_dev(input, "class", input_class_value = "flex-1 p-2 text-sm border rounded focus:outline-none\r\n      focus:shadow-md " + (/*isApproved*/ ctx[5] === 1
    			? "bg-green-200 text-green-800 border-green-600"
    			: "") + "\r\n      " + (/*isApproved*/ ctx[5] === 0
    			? "bg-red-200 text-red-800 border-red-600"
    			: "") + "\r\n      transition-all duration-150 ease-in-out");

    			add_location(input, file$4, 64, 4, 1471);
    			attr_dev(div0, "class", "flex my-4");
    			add_location(div0, file$4, 63, 2, 1442);
    			attr_dev(span0, "class", "text-gray-600 mr-1");
    			add_location(span0, file$4, 83, 4, 2159);
    			attr_dev(div1, "class", "flex flex-wrap my-4 text-sm");
    			add_location(div1, file$4, 82, 2, 2112);
    			attr_dev(span1, "class", "flex-1 text-xs break-all");
    			add_location(span1, file$4, 88, 4, 2449);
    			attr_dev(button, "class", "flex-shrink-0 ml-8 py-1 px-2 text-xs bg-indigo-500 text-white\r\n        rounded");
    			add_location(button, file$4, 98, 6, 2838);
    			attr_dev(div2, "class", "relative");
    			add_location(div2, file$4, 89, 4, 2512);
    			attr_dev(div3, "class", "flex items-center p-2 text-gray-700 bg-gray-200 rounded");
    			add_location(div3, file$4, 87, 2, 2374);
    			attr_dev(div4, "class", "mb-4 p-4 bg-white border rounded-md");
    			add_location(div4, file$4, 61, 0, 1312);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input, "input", /*changeHandle*/ ctx[7], false, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*isApproved*/ 32 && input_class_value !== (input_class_value = "flex-1 p-2 text-sm border rounded focus:outline-none\r\n      focus:shadow-md " + (/*isApproved*/ ctx[5] === 1
    			? "bg-green-200 text-green-800 border-green-600"
    			: "") + "\r\n      " + (/*isApproved*/ ctx[5] === 0
    			? "bg-red-200 text-red-800 border-red-600"
    			: "") + "\r\n      transition-all duration-150 ease-in-out")) {
    			...
    			if (dirty & /*changeChecked*/ 8) option1_changes.checked = /*changeChecked*/ ctx[3];
    			option1.$set(option1_changes);
    			if ((!current || dirty & /*rule*/ 1) && t8_value !== (t8_value = /*rule*/ ctx[0].rule + "")) set_data_dev(t8, t8_value);
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	function toggleHandle(e) {
    		...
    		} else if (detail === "change") {
    			$$invalidate(3, changeChecked = !changeChecked);
    		}
    	}

    	function changeHandle() {
    		if (changeChecked && value.trim()) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("changeChecked" in $$props) $$invalidate(3, changeChecked = $$props.changeChecked);
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(svg, "width", "24");
    			attr_dev(svg, "height", "24");
    			add_location(svg, file$6, 38, 4, 1207);
    			attr_dev(div, "class", "fixed right-0 bottom-0 mb-8 mr-8 p-3 bg-indigo-600 text-white\r\n    bg-opacity-75 rounded-full cursor-pointer");
    			add_location(div, file$6, 33, 2, 962);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, svg);
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	function scrollToTop() {
    		...
    		timer = requestAnimationFrame(function fn() {
    			...
    			if (oTop > 0) {
    				document.body.scrollTop = document.documentElement.scrollTop = oTop - oTop / 4; //可以调整数字明确放慢速度20->50,为0时为正常速度
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(37:6) {#each rules as rule}",
    		ctx
    	});
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 35, 4, 884);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(34:2) <Container className=\\\"pt-6\\\">",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(style, file$7, 21, 2, 552);
    			attr_dev(main, "class", "min-w-screen min-h-screen pb-8 bg-gray-200");
    			add_location(main, file$7, 31, 0, 720);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
