    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$2, 38, 10, 1048);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "w-full p-4 h-16 pr-16 shadow rounded-md border-2 border-indigo-400\r\n    focus:border-indigo-400 focus:outline-none");
